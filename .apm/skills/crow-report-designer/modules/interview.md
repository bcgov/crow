...
1. scope, users, outcome; 2. reporting questions and measures; 3. fact grain and history; 4. source systems and freshness; 5. filters, time, and navigation; 6. dimensions, conformance, and bus matrix; 7. security/RLS, environments, and operational constraints; 8. visual/report delivery and acceptance; 9. refresh/performance, risks, decisions, glossary, and sign-off.
