...
5. Apply the minimal-change decision ladder before creating a new asset, abstraction, dependency, or output contract. Preserve security, accessibility, correctness, and release gates when simplifying.
