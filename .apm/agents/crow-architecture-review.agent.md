...
description: 'Inspects a repository and creates or updates verified, service-scoped architecture documentation under docs/.'
...
4. Load the repository-inspection module and the architecture template. Load `crow-application-architecture/modules/unicode-and-utf8.md` for the Unicode review. Perform each inspection pass within the classified application or service boundary.
...
8. Complete every item in Section 11 of the architecture template. Check an item only when evidence verifies it and always fill its confidence annotation.
